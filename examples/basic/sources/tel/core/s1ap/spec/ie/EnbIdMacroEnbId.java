// Generated from S1AP ASN.1 type EnbIdMacroEnbId.
...
public final class EnbIdMacroEnbId implements InformationElement {
    private static final AsnAper.Range RANGE = new AsnAper.Range("20:20");
    private final AsnBitString.Value value;

    public EnbIdMacroEnbId(BitInput in) {
        try {
    ...
    public EnbIdMacroEnbId(AsnBitString.Value value) {
