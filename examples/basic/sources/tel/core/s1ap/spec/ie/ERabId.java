...
public final class ERabId implements InformationElement {
    private static final AperRange RANGE = new AperRange("0:15");
    private final BigInteger value;

    public ERabId(BitInput in) {
        try {
            this.value = aperInteger(in, RANGE, true, false);
    ...
    public ERabId(BigInteger value) {
        aperValidate(value, RANGE, true, false);
        this.value = value;
    }
    ...
    public void encode(BitOutput out) {
        aperInteger(out, value, RANGE, true, false);
    }
